      ...
      >
        ...
        <AccordionDetails>
          ...
          <ul>
            ...
            <li>Оперативное формирование статистических показателей по ЛПУ</li>
          </ul>
        ...
        <AccordionDetails>
          ...
          <ul>
            <li>
              ...
              исследованиями: от направления до получения результатов в карту и
              визирования врачом
            </li>
          ...
          <ul>
            ...
            <li>Резервирование медикаментов и аптечных товаров за пациентом</li>
            <li>
              Возможность создания склада или места хранения на уровне рабочего
          ...
          <ul>
            <li>
              Быстрое решение оперативных задач, связанных с интерфейсом системы
              и процессом лечения
            </li>
            <li>
