        ...
        >
          ...
          >
            ...
            <Typography variant="body2" my={1}>
              Медиалог.Коллекция — кристаллизованный опыт более чем 900
              внедрений МИС МЕДИАЛОГ, десятки из которых - в крупнейших
              медицинских учреждениях страны, как многопрофильных, так и
              специализированных.
            </Typography>
          </AccordionSummary>
          <AccordionDetails>
            <Typography variant="body2" my={1}>
              Это готовые к использованию наборы настроек платформы Медиалог,
              реализующие лучшие практики ведения бизнес-процессов, медицинских
              протоколов и отчетности.
              <br />
              <br />В настоящий момент Медиалог.Коллекция насчитывает свыше 50
              готовых медицинских профилей как широкого профиля, так и узкой
              врачебной специализации. Полная информация о составе коллекции
